/*
Programa para simular a función dunha xanela dun automovil de maneira 
simplificada. O pulsador accionara o motor de subida ao ser pulsado. Cando pulsemos novamente 
o motor e, unha terceira fai que se accione o motor de baixada.
...
int contador = 0; // Contador número de impulsos do motor
